...
<body>
     <nav class="navbar navbar-expand-lg border border-rounded  bg-primary bg-opacity-50 " style="width: 1300px; justify-content: center; margin: auto; border-radius:10px;">
        <div class="container ">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="over.html">Over mij</a>
                    </li>
                    <li class="nav-item">
